...
public class ClouderaHiveJdbcExample {
    ...
    private static final String SQL_STATEMENT = "select * from  hbase_vehicletrajectoryanalysis_result limit 10";

    // set the impalad host
    private static final String HIVE_HOST = "cdh01";

    // port 21050 is the default impalad JDBC port
    private static final String HIVE_JDBC_PORT = "21050";
